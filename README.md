...
## 🧩 Ground Truth Tumor Visualization

A central axial slice from the BraTS dataset showing the **MRI and true tumor annotation**.
...
Predicted tumor mask generated by our trained **3D U-Net** model.
